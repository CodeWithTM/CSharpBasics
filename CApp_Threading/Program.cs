...
namespace CApp_Threading
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            Console.WriteLine(Environment.OSVersion + Environment.MachineName + Environment.Version + Environment.ProcessorCount);

            CS_Delegates cS_Delegates = new CS_Delegates();
            cS_Delegates.Main(args);

            //AsyncAwait asyncAwait = new AsyncAwait();
            //asyncAwait.Main(args);

            //ContuniationTsk cTask = new ContuniationTsk();
            //cTask.Main(args);

            //TaskCls tsk = new TaskCls();
            //tsk.Main(null);

            //DeadLockExp dead = new DeadLockExp();
            //dead.Main(null);


            //ARE_MRE_MUTEX_SEMA obj = new ARE_MRE_MUTEX_SEMA();
            //obj.Main(null);

            //SharedResources sr = new SharedResources();
            //sr.Main(null);

            //CallBackDel obj1 = new CallBackDel();
            //obj1.Main(null);
